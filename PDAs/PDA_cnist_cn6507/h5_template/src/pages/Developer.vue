  ...
  <AppCan>
    <div class="page-content">
      ...
      <div class="btns">
        ...
        <van-button type="primary" block class="btn" @click="onTest">打印条形码</van-button>
        <van-button type="primary" block class="btn" @click="onTest2">打印二维码</van-button>
...
onMounted(() => {
  window.onDeviceScan = (res: string) => {
    result.value = res
  }
})

const onTest = () => {
  window.Android.printBarcode("12345678")
}

const onTest2 = () => {
  window.Android.printQRcode("12345678")
}
